...
// \u2500\u2500 \u{1F4C5} \u5386\u53F2\u5019\u9009\uFF08/api/forward-history\uFF0C\u5317\u4EAC\u65E5\u754C\uFF09\u2500\u2500
...
function fwdHistPanel() {
  ...
  H += '<button class="btn" onclick="fwdHistToggle()">\u{1F4C5} \u5386\u53F2\u5019\u9009' + (fwdHistOpen ? ' \u25BE' : ' \u25B8') + '</button>';
...
// \u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550
// \u{1F4E1} \u{1F9ED} \u7B5B\u5E01\u5DE5\u4F5C\u53F0 \u89C6\u56FE\uFF08\u7B2C 5 tab\uFF09\u2014 L0-L5 \u5B8C\u6574\u7B5B\u5E01\u903B\u8F91
...
function scAhLoad() {
  ...
  panel.innerHTML = '<div class="empty-msg" style="padding:14px">\u{1F558} \u6B63\u5728\u67E5\u8BE2 ' + scAhHours + ' \u5C0F\u65F6\u5185\u5165\u9009\u8FC7\u7684\u5E01...</div>';
...
// \u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550
// \u{1F3AF} \u6DA8\u5E45\u699C\u91CD\u5408 \u89C6\u56FE\uFF08\u7B2C 6 tab\uFF09\u2014 \u6BCF\u65E5\u5019\u9009\u6C60 \u2229 \u5F53\u65E5\u6DA8\u5E45\u699C
...
function dgLoad() {
  ...
  fetch(BASE + '/api/overlap-stats?days=' + dgDays + '&topn=20&minvol=0')
    .then(function (r) { return r.json(); }).then(function (d) {
      ...
      root.innerHTML = '<div class="empty-msg">\u{1F4C5} \u65E5\u699C\u6570\u636E\u52A0\u8F7D\u5931\u8D25<br><br><button class="btn" onclick="dgLoad()">\u91CD\u8BD5</button></div>';
    });
}
...
function renderDayList() {
  ...
  H += '<span style="font-size:15px;font-weight:800;background:linear-gradient(90deg,#60a5fa,#34d399);-webkit-background-clip:text;background-clip:text;color:transparent">\u{1F4C5} \u65E5\u699C\u56DE\u770B</span>';
  H += '<span class="dim" style="font-size:12px">\u70B9\u65E5\u671F\u770B\u5F53\u5929\u6DA8\u5E45\u699C\uFF0C\u{1F3C6} = \u4F60\u7684\u7B5B\u9009\u5668\u7B5B\u51FA\u8FC7</span>';
  ...
  if (dgPerf && dgPerf.summary) {
    ...
    H += '<div style="display:flex;align-items:center;gap:8px;margin-bottom:10px"><span style="font-size:13px;font-weight:800;color:#e2e8f0">\u{1F4CA} \u5019\u9009\u6C60\u8868\u73B0</span><span class="dim" style="font-size:11px">\u6BCF\u65E5\u5165\u9009\u5019\u9009\u7684 fwd \u6536\u76CA vs BTC\uFF08' + dgPerf.summary.n_days + ' \u5929\u6837\u672C\uFF09</span></div>';
  ...
  if (dgActive && detail && detail.date === dgActive) {
    ...
    H += '<div class="dim" style="font-size:10.5px;letter-spacing:.5px">\u{1F3C6} \u7B5B\u9009\u5668\u547D\u4E2D</div>';
    ...
    ['#', '\u5E01\u79CD', '24H \u6DA8\u5E45', '\u6210\u4EA4\u989D', '\u7B5B\u9009\u5668\u72B6\u6001', '\u5165\u9009\u4EF7 \u2192 \u4E0A\u699C\u4EF7', '\u57CB\u4F0F\u6536\u76CA', '\u9886\u5148(\u9996\u6B21\u5165\u9009\xB7\u6B21\u6570)', '\u8BC4\u5206', ''].forEach(function (h) {
    ...
    gs.forEach(function (g, idx) {
      ...
      var statHtml;
      if (g.is_candidate) statHtml = '<span style="display:inline-block;padding:2px 8px;border-radius:999px;font-size:10.5px;font-weight:700;background:rgba(16,185,129,0.15);color:#34d399">\u{1F3C6} \u5F53\u5929\u5019\u9009</span>';
      ...
      else if (isHit) statHtml = '<span style="display:inline-block;padding:2px 8px;border-radius:999px;font-size:10.5px;font-weight:700;background:rgba(251,191,36,0.12);color:#fbbf24">\u{1F3C6} \u4E4B\u524D\u7B5B\u51FA\u8FC7</span>';
      ...
      if (g.ever_candidate && g.first_seen) {
        ...
        if (ts && !isNaN(ts.getTime())) {
          ...
          leadTimeHtml = '<div style="font-size:10.5px;color:#64748b;margin-top:2px">' + mo + '-' + dd + ' ' + hh + ':' + mm + (g.cand_days > 1 ? ' \xB7 \u5165\u9009' + g.cand_days + '\u5929' : '') + '</div>';
        }
      }
    ...
    H += '</tbody></table></div>';
    H += '<div class="dim" style="font-size:11px;margin-top:10px">\u{1F3C6} \u5F53\u5929\u5019\u9009 = \u8BE5\u5E01\u5F53\u5929\u5728\u7B5B\u9009\u5668\u5019\u9009\u6C60\uFF1B\u4E4B\u524D\u7B5B\u51FA\u8FC7 = \u5F80\u524D30\u5929\u5185\u5165\u9009\u8FC7\uFF1B**\u57CB\u4F0F\u6536\u76CA = \u9996\u6B21\u5165\u9009\u65E5\u6536\u76D8\u4EF7 \u2192 \u4E0A\u699C\u65E5\u6536\u76D8\u4EF7**\uFF08= \u7B5B\u9009\u5668\u63D0\u524D\u57CB\u4F0F\u7684\u8D26\u9762\u6536\u76CA\uFF0C\u975E\u5F53\u65E5\u6DA8\u5E45\uFF09\u3002\u70B9\u51FB\u5E01\u53EF\u8DF3\u524D\u5BFC\u7B5B\u9009\u3002</div>';
...
function renderScreener() {
  ...
  H += '</div>';
  H += '<div class="fwd-stats">\u{1F9ED}\u5019\u9009 ' + nAcc + ' \xB7 \u26D4\u56DE\u907F ' + nAvoid + ' \xB7 \u{1F514}\u544A\u8B66 ' + nAlert + ' \xB7 \u26A0\uFE0F\u8584\u76D8\u53E3 ' + nThin + (scAppearTotal > 0 ? ' \xB7 \u{1F4CA} 7\u5929\u51FA\u73B0 ' + scAppearTotal + ' \u6B21' : '') + '</div>';
  H += '<div class="fwd-bar" style="margin-top:10px;flex-wrap:wrap;gap:6px;align-items:center">';
  H += '<span class="dim" style="font-weight:700;color:var(--accent,#60a5fa)">\u{1F558} \u5386\u53F2\u51FA\u73B0</span>';
...
`;
  ...
  async function healGainerArchive(kv) {
    ...
    if (pU > 30 * 60 * 1e3) {
      console.log("heal skip: exchange_proxy stale", pU / 6e4, "min");
      return;
    }
  ...
  async function hRWF(req, kv) {
    ...
    try {
      ...
      try {
        ...
        const cutoff = new Date(Date.parse(day) - 7 * 864e5).toISOString().slice(0, 10);
        for (const d of Object.keys(ac.days)) {
          if (d < cutoff) delete ac.days[d];
        }
        ac.updated = n;
        await kv.put(acKey, JSON.stringify(ac));
      } catch (e) {
        console.log("appear_count error:", e.message);
      }
      return json({ ok: true, coins: b.data.length, updated: n });
    } catch (e) {
      return json({ ok: false, error: e.message }, 400);
  ...
  async function hOV(kv, url) {
    ...
    for (const ds of daysArr) {
      ...
      for (const c of raw[ds].cands) {
        const ts = c.first_seen || ds;
        if (!firstSeen[c.base_asset] || ts < firstSeen[c.base_asset]) firstSeen[c.base_asset] = ts;
      }
    }
    const bestScore = {};
    for (const ds of daysArr) {
    ...
    for (const ds of daysArr) {
      ...
      if (raw[ds].cands && raw[ds].gainers) {
        ...
        day.overlap = raw[ds].gainers.filter((g) => candSet.has(g.base_asset)).map((g) => ({ base_asset: g.base_asset, change_24h_pct: g.change_24h_pct, rank: raw[ds].gainers.indexOf(g) + 1, first_seen: firstSeen[g.base_asset], first_seen_date: (firstSeen[g.base_asset] || "").slice(0, 10) }));
    ...
    for (const ds of daysArr) {
      ...
      for (let k = 0; k < raw[ds].gainers.length; k++) {
        ...
        if (!fs) continue;
        const fsDate = fs.slice(0, 10);
        if (fsDate < ds) {
          leadEvents.push({ base_asset: g.base_asset, first_seen: fs, first_seen_date: fsDate, gain_day: ds, lead_days: (Date.parse(ds) - Date.parse(fsDate)) / 864e5, change_24h_pct: g.change_24h_pct, rank: k + 1 });
        }
      }
    }
    const leadUnion = {};
  ...
  async function hDG(kv, url) {
    ...
    winDates.forEach((ds, idx) => {
      ...
      try {
        ...
        for (const c of cs) {
          const ts = c.first_seen || ds;
          if (!firstSeen[c.base_asset] || ts < firstSeen[c.base_asset]) firstSeen[c.base_asset] = ts;
          if (!candDays[c.base_asset]) candDays[c.base_asset] = 0;
          candDays[c.base_asset]++;
          if (c.forward_score != null && (bestScore[c.base_asset] == null || c.forward_score > bestScore[c.base_asset])) bestScore[c.base_asset] = c.forward_score;
        }
      } catch (e) {
      }
    ...
    const out = gs.map((g, k) => {
      ...
      const fsDate = fs ? fs.slice(0, 10) : null;
      const ever = !!fs;
      const lead = fsDate && fsDate < date ? Math.round((Date.parse(date) - Date.parse(fsDate)) / 864e5) : 0;
  ...
  __name(hDG, "hDG");
  async function hGB(req, kv) {
    const k = RELAY_AUTH_KEY, a = req.headers.get("X-Auth-Key");
    if (!k || a !== k) return json({ ok: false, error: "Unauthorized" }, 401);
    try {
      const b = await req.json();
      if (!b || !b.date || !Array.isArray(b.gainers)) return json({ ok: false, error: "Must be {date,gainers:[...]}" }, 400);
      if (!/^\d{4}-\d{2}-\d{2}$/.test(b.date)) return json({ ok: false, error: "invalid date" }, 400);
      const now = /* @__PURE__ */ new Date();
      const todayBJ = new Date(now.getTime() + 8 * 3600 * 1e3).toISOString().slice(0, 10);
      if (b.date > todayBJ) return json({ ok: false, error: "future date" }, 400);
      const ageDays = Math.round((Date.parse(todayBJ) - Date.parse(b.date)) / 864e5);
      if (ageDays > 3) return json({ ok: false, error: "too old, max 3 days" }, 400);
      const dayKey = "gainer_hist_" + b.date.replace(/-/g, "");
      const prev = await kv.get(dayKey);
      let prevCount = 0;
      if (prev) {
        try {
          prevCount = (JSON.parse(prev).gainers || []).length;
        } catch (e) {
        }
      }
      ...
      return json({ ok: true, date: b.date, count: b.gainers.length });
    } catch (e) {
      return json({ ok: false, error: e.message }, 400);
    }
  }
  ...
  async function hAH(kv, url) {
    ...
    const now = /* @__PURE__ */ new Date();
    const cutoff = new Date(now.getTime() - hours * 3600 * 1e3);
    const daysArr = [];
    ...
    if (ac && ac.days) {
      for (const d of Object.keys(ac.days)) {
        for (const ba of Object.keys(ac.days[d])) {
          appear[ba] = (appear[ba] || 0) + ac.days[d][ba];
        }
      }
    }
    const bySym = {};
    daysArr.forEach((ds, idx) => {
      ...
      try {
        ...
        for (const c of p.candidates || []) {
          ...
          const ex = bySym[ba];
          if (!ex) {
            bySym[ba] = { base_asset: ba, first_seen: fs, last_seen: ls, days: 1, best_score: c.forward_score != null ? c.forward_score : null };
          } else {
  ...
  async function hSC(kv) {
    ...
    if (ar) {
      try {
        const p = JSON.parse(ar);
        if (p.days) {
          for (const d of Object.keys(p.days)) {
            for (const ba of Object.keys(p.days[d])) {
              appear[ba] = (appear[ba] || 0) + p.days[d][ba];
              appearTotal += p.days[d][ba];
            }
          }
        }
      } catch (e) {
    ...
    return json({ ok: true, updated: (/* @__PURE__ */ new Date()).toISOString(), count: rows.length, env, appear_total: appearTotal, data: rows });
  }
  __name(hSC, "hSC");
