...
var AUTH_CACHE_TTL_MS = 60 * 1e3;
var HOMEPAGE_CACHE_TTL_MS = 5 * 60 * 1e3;
...
var siteAuthCache = { value: null, at: 0 };
var homepageCache = { value: null, at: 0 };
...
__name(readKvSafely, "readKvSafely");
async function getSiteAuth(kv, env) {
  ...
  if (raw === null || raw === void 0 || quotaExhausted) {
