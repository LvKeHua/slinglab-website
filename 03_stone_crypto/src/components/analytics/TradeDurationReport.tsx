...
import type { DurationBucketData } from "@/utils/analytics"

interface TradeDurationReportProps {
  data: DurationBucketData[]
}

export function TradeDurationReport({ data }: TradeDurationReportProps) {
  return (
    <Card>
      <CardHeader className="pb-2"><CardTitle className="text-sm font-medium">Trade Duration Report</CardTitle></CardHeader>
      <CardContent>
