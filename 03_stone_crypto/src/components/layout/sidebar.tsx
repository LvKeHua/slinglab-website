...
const navItems = [
  ...
  { href: "/portfolio", label: "Portfolio", icon: Crosshair },
  { href: "/accounts", label: "Accounts", icon: Wallet },
  { href: "/wallets", label: "Wallets", icon: Landmark },
  { href: "/performance", label: "Performance", icon: TrendingUp },
  { href: "/calendar", label: "Calendar", icon: CalendarDays },
  { href: "/market-radar", label: "Market Radar", icon: Radar },
  { href: "/funding-heatmap", label: "Funding Heatmap", icon: Grid3x3 },
      ...
      <div className="p-2 space-y-1">
        {!collapsed && (
          <Button
            ...
            onClick={() => window.dispatchEvent(new Event("sticky-notes-toggle"))}
          >
