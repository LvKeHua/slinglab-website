/**
 * Sync service — pulls balances and trade history for every enabled account,
 * persists snapshots (balance history) and closed trades to SQLite.
 */
import type { Db } from "../db.js";
import { getDecryptedCreds, listAccounts, getAccount } from "./accounts.js";
import { fetchExchangeBalances, fetchCrossExBalances, type ExchangeKind } from "./exchanges/balances.js";
import { fetchBinanceTrades, fetchCrossExTrades } from "./trades.js";
